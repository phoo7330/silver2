...
public class DetailsOne {
	...
	public DetailsOne(int seach_seq, int type, String areaa, String areab, String areac, String silvername,
			...
			int hp_details_seq, int information_seq, String establishment, String hp_service, String protection,
			String location, String religion, String hospital_tel, String hp_address, String holiday, String lunchtime,
			String receipttime, String facilityinformation, String treatment) {
		super();
	...
	public String toString() {
		return "DetailsOne [seach_seq=" + seach_seq + ", type=" + type + ", areaa=" + areaa + ", areab=" + areab
				...
				+ ", hp_details_seq=" + hp_details_seq + ", information_seq=" + information_seq + ", establishment="
				+ establishment + ", hp_service=" + hp_service + ", protection=" + protection + ", location=" + location
				+ ", religion=" + religion + ", hospital_tel=" + hospital_tel + ", hp_address=" + hp_address
				+ ", holiday=" + holiday + ", lunchtime=" + lunchtime + ", receipttime=" + receipttime
				+ ", facilityinformation=" + facilityinformation + ", treatment=" + treatment + "]";
	}
}